    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sendFrom = binding.txtEditSendFrom.getText().toString();

                String generalInfo = binding.editTextGeneral.getText().toString();
                ...
                OurDataSetTrip ourDataSetTrip = new OurDataSetTrip(lat,lon,description,title,encodedFile,sendFrom,generalInfo);
